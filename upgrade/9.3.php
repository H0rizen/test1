...
$tableSchema[] = "ALTER TABLE `" . PREFIX . "_obmen` ADD `target` VARCHAR(10) NOT NULL DEFAULT ''";
...
$con_file = fopen(ENGINE_DIR.'/data/videoconfig.php', "w+") or die("سطح دسترسی فایل <b>.engine/data/videoconfig.php</b>.<br /> را روی 666 قرار دهید!");
...
msgbox("info","Information", "<form action=\"index.php\" method=\"GET\">پایگاه داده از <b>9.3</b> به <b>9.4</b> با موفقیت آپگرید شد.<br />{$error_info}<br />لطفا برای ادامه پردازش بر روی \"ادامه...\" کلیک کنید<br /><br /><input type=\"hidden\" name=\"next\" value=\"9.4\"><input class=\"edit\" type=\"submit\" value=\"ادامه ...\"></form>");
?>