...
$con_file = fopen(ENGINE_DIR.'/data/videoconfig.php', "w+") or die("سطح دسترسی فایل <b>.engine/data/videoconfig.php</b>.<br />را روی 666 قرار دهید CHMOD!");
...
if ($db->error_count) {
	...
	$error_info = "Total scheduled queries: <b>".$db->query_num."</b>Failed to execute query: <b>".$db->error_count."</b>.Perhaps they have already been implemented earlier.";
...
msgbox("info","Information", "<form action=\"index.php\" method=\"GET\">پایگاه داده از <b>9.2</b> به <b>9.3</b> با موفقیت آپگرید شد.<br />{$error_info}<br />لطفا برای ادامه پردازش بر روی \"ادامه...\" کلیک کنید<br /><br /><input type=\"hidden\" name=\"next\" value=\"next\"><input class=\"edit\" type=\"submit\" value=\"ادامه ...\"></form>");
?>