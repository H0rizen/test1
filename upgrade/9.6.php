...
msgbox("info","Information", "<form action=\"index.php\" method=\"GET\">پایگاه داده از <b>9.6</b> به <b>9.7</b> با موفقیت آپگرید شد.<br />{$error_info}<br />لطفا برای ادامه پردازش بر روی \"ادامه...\" کلیک کنید<br /><br /><input type=\"hidden\" name=\"next\" value=\"next\"><input class=\"edit\" type=\"submit\" value=\"ادامه ...\"></form>");
?>