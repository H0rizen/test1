...
<!--MAIN area-->
	...
	<div class="login box" style="margin-top: 100px;">
      ...
      <div class="box-header">
        <span class="title">{$lang['skin_title']} دیتالایف انجین</span>
      </div>
	...
	<div class="text-center">Copyright 2006-2016 &copy; <a href="http://www.datalifeengine.ir" target="_blank">Datalife Engine Farsi</a>. All rights reserved.</div>
