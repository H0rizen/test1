...
if ($_REQUEST['step'] == 3) {
$buffer = <<<HTML
<br />{$lang['clean_comments']}<br /><br />{$lang['addnews_date']}&nbsp;<input id="f_date_c" type="text" name="date" id="f_date_c" size="20" class="ltr">
...
if ($_REQUEST['step'] == 1) {
$buffer = <<<HTML
<br />{$lang['clean_news']}<br /><br />{$lang['addnews_date']}&nbsp;<input id="f_date_c" type="text" name="date" id="f_date_c" size="20" class="ltr">
<script type="text/javascript">Calendar.setup({inputField:"f_date_c",ifFormat:"%Y-%m-%d",align:"Br",timeFormat:"24",dateType:"jalali",singleClick:true});</script>
<br /><br /><font color="red"><span id="status"></span></font><br /><br />
