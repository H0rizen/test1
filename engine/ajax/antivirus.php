...
if ($_REQUEST['folder'] != "snap") {
	...
	if (strpos ( $con_content, "_SERVER" ) !== false OR strpos ( $con_content, "eval" ) !== false) {
		...
		$file_date = jdate("d M Y H:i:s", filectime(ROOT_DIR . "/engine/data/config.php"));
	...
	if (strpos ( $con_content, "_SERVER" ) !== false OR strpos ( $con_content, "eval" ) !== false) {
		...
		$file_date = jdate("d M Y H:i:s", filectime(ROOT_DIR . "/engine/data/dbconfig.php"));
	...
	if (strpos ( $con_content, "_SERVER" ) !== false OR strpos ( $con_content, "eval" ) !== false) {
		...
		$file_date = jdate("d M Y H:i:s", filectime(ROOT_DIR . "/engine/data/videoconfig.php"));
