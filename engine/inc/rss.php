...
if( $_REQUEST['action'] == "addnews" ) {
	...
	foreach ( $xml->content as $content ) {
		if( $rss['text_type'] ) {
			...
			$xml->content[$i]['date'] = jdate( "Y-m-d H:i:s", $xml->content[$i]['date'] );
...
HTML;
	...
	<br /><input id="PersianDate_A" type="text" name="content[' . $i . '][date]" size="20" value="' . $content['date'] . '" class="ltr">
	</td>
  ...
  <div class="box-content">
	...
	<div class="row box-section">
		<div class="form-group">
		  ...
		  <div class="col-lg-10">
			<input type="text" style="width:100%;max-width:350px;" name="rss_url" value="{$rss_url_value}" class="ltr">&nbsp;<span class="help-button" data-rel="popover" data-trigger="hover" data-placement="right" data-content="{$lang['rss_hurl']}" >?</span>
		  </div>
		 </div>	
		<div class="form-group">
		...
		<div class="form-group">
		  ...
		  <div class="col-lg-10">
			<textarea cols="50" rows="5" name="rss_search" class="ltr">{$rss_search_value}</textarea>&nbsp;<span class="help-button" data-rel="popover" data-trigger="hover" data-placement="right" data-content="{$lang['rss_hsearch']}" >?</span>
		  </div>
		 </div>	
		<div class="form-group">
		  <label class="control-label col-lg-2">{$lang['rss_cookie']}</label>
		  <div class="col-lg-10">
			<textarea cols="50" rows="5" name="rss_cookie" class="ltr">{$rss_cookie_value}</textarea>&nbsp;<span class="help-button" data-rel="popover" data-trigger="hover" data-placement="right" data-content="{$lang['rss_hcookie']}" >?</span>
		  </div>
		 </div>	
		<div class="form-group">
