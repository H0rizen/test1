...
echo"<HTML>
    ...
    <style type=\"text/css\">
	<!--
	a:active,a:visited,a:link {color: #446488; text-decoration: none; font-family: Tahoma; font-size: 8pt;}
	a:hover {color: #00004F; text-decoration: none; font-family: Tahoma; font-size: 8pt; }
	.code {
		font-family : tahoma;
		font-size : 11px;
	...
	BODY, TD, TR {text-align:justify ;padding: 0; leftMargin: 0; topMargin: 0; text-decoration: none; font-family: Tahoma; font-size: 8pt; cursor: default;}
	-->
	</style>
