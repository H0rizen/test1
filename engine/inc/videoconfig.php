...
HTML;
	...
	showRow( $lang['vconf_widht'], $lang['vconf_widhtd'], "<input type=text style=\"text-align: center;\" class=ltr name=\"save_con[width]\" value=\"{$video_config['width']}\" size=20>", "white-line" );
	showRow( $lang['vconf_height'], $lang['vconf_heightd'], "<input type=text style=\"text-align: center;\" class=ltr name=\"save_con[height]\" value=\"{$video_config['height']}\" size=20>" );
	showRow( $lang['vconf_awidht'], $lang['vconf_awidhtd'], "<input type=text style=\"text-align: center;\" class=ltr name=\"save_con[audio_width]\" value=\"{$video_config['audio_width']}\" size=20>" );
