  ...
  <div class="box-content">
	...
	<div class="row box-section">
		...
		<div class="form-group">
		  ...
		  <div class="col-lg-10">
			<input type="text" size="10" name="start_from" value="0" class="ltr" style="text-align: center;"> {$lang['nl_user']}
		  </div>
		 </div>	
		<div class="form-group">
		  <label class="control-label col-lg-2">{$lang['nl_n_mail']}</label>
		  <div class="col-lg-10">
			<input type="text" size="10" name="limit" value="20" class="ltr" style="text-align: center;">
		  </div>
		 </div>	
		<div class="form-group">
		  <label class="control-label col-lg-2">{$lang['nl_interval']}</label>
		  <div class="col-lg-10">
			<input type="text" size="10" name="interval" value="3" class="ltr" style="text-align: center;"> ثانیه
		  </div>
		 </div>	
		<div class="form-group">
		...
		<div class="form-group">
		  <label class="control-label col-lg-2"></label>
		  <div class="col-lg-10">
			<input type="submit" class="btn btn-blue" value="ثبت و مرحله بعد">
		  </div>
		 </div>	
	 </div>
