...
HTML;
		...
		$entries .= "{$my_cat}<td style=\"text-align: center;\"><a href=\"?mod=editusers&action=list&search=yes&search_name=" . $row['autor'] . "\">" . $row['autor'] . "</a>
	...
	<div class="row box-section">
	  ...
	  <div class="col-md-6">
		...
		<div class="form-group">
		  ...
		  <div class="col-lg-9">
			{$lang['edit_fdate']} <input id="PersianDate_A" type="text" name="fromnewsdate" id="fromnewsdate" size="14" maxlength="16" value="{$fromnewsdate}" class="ltr">
 			{$lang['edit_tdate']} <input id="PersianDate_B" type="text" name="tonewsdate" id="tonewsdate" size="14" maxlength="16" value="{$tonewsdate}" class="ltr">
		  </div>
		 </div>
...
HTML;
	...
	if( $member_id['user_group'] == 1 ) {
		...
		$author_info = "<input type=\"text\" name=\"new_author\" size=\"20\" class=\"ltr\" value=\"{$row['autor']}\"><input type=\"hidden\" name=\"old_author\" value=\"{$row['autor']}\" />";
	...
	if( $row['editdate'] ) {
		$row['editdate'] = jdate( "d M Y ساعت H:i", $row['editdate'] );
                     ...
                     <div class="tab-pane active" id="tabhome">
						<div class="row box-section">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-10">
								شماره خبر: <b>{$row['id']}</b> ، {$lang['edit_eau']} {$author_info}
							  </div>
							 </div>
                    ...
                    <div class="tab-pane" id="tabextra" >
						<div class="row box-section">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-10">
								<input type="text" name="catalog_url" class="ltr" size="5" value="{$row['symbol']}">&nbsp;<span class="help-button" data-rel="popover" data-trigger="hover" data-placement="right" data-content="{$lang['catalog_hint_url']}" >?</span>
							  </div>
							 </div>
							<div class="form-group">
							  <label class="control-label col-md-2">{$lang['addnews_url']}</label>
							  <div class="col-md-10">
								<input type="text" name="alt_name" class="ltr" style="width:100%;max-width:437px;" value="{$row['alt_name']}">&nbsp;<span class="help-button" data-rel="popover" data-trigger="hover" data-placement="right" data-content="{$lang['hint_url']}" >?</span>
							  </div>
							 </div>
							<div class="form-group">
...
elseif( $action == "doeditnews" ) {
	...
	else $alt_name = fatotranslit( stripslashes( $_POST['alt_name'] ) );
