...
<table class="table table-normal table-hover settingsgr">
    ...
    <tr>
        ...
        <td><input type="text" style="width:100%;" name="group_icon" value="{$group_icon_value}" class="ltr"></td>
    </tr>
	
    <tr>
        <td><h6>{$lang['group_pref']}</h6><span class="note large">{$lang['hint_gpref']}</span></td>
        <td><input type="text" style="width:100%;" name="group_prefix" value="{$group_prefix_value}" class="ltr"></td>
    </tr>
	
    <tr>
        <td><h6>{$lang['group_suf']}</h6><span class="note large">{$lang['hint_gsuf']}</span></td>
        <td><input type="text" style="width:100%;" name="group_suffix" value="{$group_suffix_value}" class="ltr"></td>
    </tr>
   ...
   <tr>
    ...
    <tr>
        ...
        <td><input type="text" size="20" name="max_pm_day" value="{$max_pm_day_value}" class="ltr"></td>
    </tr>
	
    <tr>
        <td><h6>{$lang['group_mpm']}</h6><span class="note large">{$lang['hint_gmpm']}</span></td>
        <td><input type="text" size="20" name="max_pm" value="{$max_pm_value}" class="ltr"></td>
    </tr>
	
    <tr>
        <td><h6>{$lang['group_memd']}</h6><span class="note large">{$lang['hint_memd']}</span></td>
        <td><input type="text" size="20" name="max_mail_day" value="{$max_mail_day_value}" class="ltr"></td>
    </tr>
	

    <tr>
        <td><h6>{$lang['group_mfot']}</h6><span class="note large">{$lang['hint_gmphoto']}</span></td>
        <td><input type="text" size="20" name="max_foto" value="{$max_foto_value}" class="ltr"></td>
    </tr>
	
    <tr>
        <td><h6>{$lang['group_max_info']}</h6><span class="note large">{$lang['hint_max_info']}</span></td>
        <td><input type="text" size="20" name="max_info" value="{$max_info_value}" class="ltr"></td>
    </tr>
</table>
...
{$cat_add_list}
    ...
    <tr>
        ...
        <td><input type="text" size="20" name="max_images" value="{$max_images_value}" class="ltr"></td>
    </tr>
	
    <tr>
        <td><h6>{$lang['group_max_files']}</h6><span class="note large">{$lang['hint_max_files']}</span></td>
        <td><input type="text" size="20" name="max_files" value="{$max_files_value}" class="ltr"></td>
    </tr>
	
    <tr>
        <td><h6>{$lang['opt_sys_file1']}</h6><span class="note large">{$lang['opt_sys_file1d']}</span></td>
        <td><input type="text" size="60" name="files_type" value="{$files_type_value}" class="ltr"></td>
    </tr>
	
    <tr>
        <td><h6>{$lang['opt_sys_maxfile']}</h6><span class="note large">{$lang['opt_sys_maxfiled']}</span></td>
        <td><input type="text" size="20" name="max_file_size" value="{$max_file_size_value}" class="ltr"></td>
    </tr>
	
    <tr>
        <td><h6>{$lang['opt_sys_file5']}</h6><span class="note large">{$lang['opt_sys_file5d']}</span></td>
        <td><input type="text" size="20" name="files_max_speed" value="{$files_max_speed_value}" class="ltr"></td>
    </tr>
	
    <tr>
        <td><h6>{$lang['group_flood_news']}</h6><span class="note large">{$lang['hint_flood_news']}</span></td>
        <td><input type="text" size="20" name="flood_news" value="{$flood_news_value}" class="ltr"></td>
    </tr>
	
    <tr>
        <td><h6>{$lang['group_day_news']}</h6><span class="note large">{$lang['hint_day_news']}</span></td>
        <td><input type="text" size="20" name="max_day_news" value="{$max_day_news_value}" class="ltr"></td>
    </tr>
    <tr>
        <td><h6>{$lang['group_edit_days']}</h6><span class="note large">{$lang['hint_edit_days']}</span></td>
        <td><input type="text" size="20" name="max_edit_days" value="{$max_edit_days_value}" class="ltr"></td>
    </tr>
</table>
...
<table class="table table-normal table-hover settingsgr">
    ...
    <tr>
        ...
        <td><input type="text" size="20" name="disable_news_captcha" value="{$disable_news_captcha_value}" class="ltr"></td>
    </tr>
    ...
    <tr>
        ...
        <td><input type="text" size="20" name="disable_comments_captcha" value="{$disable_comments_captcha_value}" class="ltr"></td>
    </tr>
