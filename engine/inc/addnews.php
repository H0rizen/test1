                    ...
                    <div class="tab-pane" id="tabextra" >
						<div class="row box-section">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-10">
								<input type="text" name="catalog_url" class="ltr" size="5">&nbsp;<span class="help-button" data-rel="popover" data-trigger="hover" data-placement="right" data-content="{$lang['catalog_hint_url']}" >?</span>
							  </div>
							 </div>
							<div class="form-group">
							  <label class="control-label col-md-2">{$lang['addnews_url']}</label>
							  <div class="col-md-10">
								<input type="text" name="alt_name" class="ltr" style="width:100%;max-width:437px;">&nbsp;<span class="help-button" data-rel="popover" data-trigger="hover" data-placement="right" data-content="{$lang['hint_url']}" >?</span>
							  </div>
							 </div>
							<div class="form-group">
...
elseif( $action == "doaddnews" ) {
	...
	if( trim( $_POST['expires'] ) != "" ) {
		...
		if( (($expires = jstrtotime( $expires )) === - 1) OR !$expires ) {
