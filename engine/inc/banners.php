  ...
  <div class="box-content">
	...
	<div class="row box-section">
		...
		<div class="form-group">
		  ...
		  <div class="col-lg-10">
			<input id="PersianDate_A" type="text" name="start_date" size="20" value="{$start_date}" class="ltr" />&nbsp;<span class="help-button" data-rel="popover" data-trigger="hover" data-placement="right" data-content="{$lang['hint_bstart']}" >?</span>
		  </div>
		 </div>
		...
		<div class="form-group">
		  ...
		  <div class="col-lg-10">
			<input id="PersianDate_B" type="text" name="end_date" size="20" value="{$end_date}" class="ltr" />&nbsp;<span class="help-button" data-rel="popover" data-trigger="hover" data-placement="right" data-content="{$lang['hint_bend']}" >?</span>
		  </div>
		 </div>
		...
		<div class="form-group">
		  ...
		  <div class="col-lg-10">
			<div style="border: solid 1px #BBB;width:99%;" class="ltr">
		...
		<div class="form-group">
		  <label class="control-label col-lg-2">{$lang['banners_s_opt']}</label>
		  <div class="col-lg-10"><label for="optional">{$lang['banners_s']} &nbsp;</label>
HTML;
...
HTML;
	...
	while ( $row = $db->get_row() ) {
		...
		$row['descr'] = $row['descr'];
		$row['code'] = "<pre><code class='ltr'>".htmlspecialchars ($row['code'], ENT_QUOTES, $config['charset'])."</code></pre>";

		if ( $row['start'] ) $start_date = jdate( "Y/m/d - H:i", $row['start'] ); else $start_date = "--";
		if ( $row['end'] ) $end_date = jdate( "Y/m/d - H:i", $row['end'] ); else $end_date = "--";
