  ...
  <div class="box-content">
	...
	<div class="row box-section">
		<div class="form-group">
		  ...
		  <div class="col-lg-10">
			<input style="width:100%;max-width:350px;" type="text" name="rss_tag" value="{$rss_tag}" class="ltr" />&nbsp;&nbsp;&nbsp;({$lang['xf_lat']})
		  </div>
		 </div>	
		<div class="form-group">
		...
		<div class="form-group">
		  <label class="control-label col-lg-2">نمایش در موضوع:</label>
		  <div class="col-lg-10">
   ...
   {$opt_category}
		...
		<div class="form-group">
		  ...
		  <div class="col-lg-10">
			<input style="width:100%;max-width:350px;" type="text" name="rss_url" value="{$rss_url}" class="ltr" />
		  </div>
		 </div>
		<div class="form-group">
		  <label class="control-label col-lg-2">{$lang['opt_sys_an']}</label>
		  <div class="col-lg-10">
			<input style="width:100%;max-width:200px;" type="text" name="rss_date_format" value="{$rss_date_format}" class="ltr" /> <a onclick="javascript:Help('date'); return false;" class="status-info" href="#">{$lang['opt_sys_and']}</a>
		  </div>
		 </div>
		<div class="form-group">
		  <label class="control-label col-lg-2">{$lang['rssinform_template']}</label>
		  <div class="col-lg-10 ltr" style="text-align: right;">
			<input style="width:100%;max-width:200px;" type="text" name="rss_template" value="{$rss_template}" class="ltr" /> .tpl
		  </div>
		 </div>
		<div class="form-group">
		  <label class="control-label col-lg-2">{$lang['rssinform_max']}</label>
		  <div class="col-lg-10">
			<input style="width: 100px;" type="text" name="rss_max" value="{$rss_max}" class="ltr" />&nbsp;<span class="help-button" data-rel="popover" data-trigger="hover" data-placement="right" data-content="{$lang['hint_ri_max']}" >?</span>
		  </div>
		 </div>
		<div class="form-group">
		  <label class="control-label col-lg-2">{$lang['rssinform_tmax']}</label>
		  <div class="col-lg-10">
			<input style="width: 100px;" type="text" name="rss_tmax" value="{$rss_tmax}" class="ltr" />&nbsp;<span class="help-button" data-rel="popover" data-trigger="hover" data-placement="right" data-content="{$lang['hint_ri_tmax']}" >?</span>
		  </div>
		 </div>
		<div class="form-group">
		  <label class="control-label col-lg-2">{$lang['rssinform_dmax']}</label>
		  <div class="col-lg-10">
			<input style="width: 100px;" type="text" name="rss_dmax" value="{$rss_dmax}" class="ltr" />&nbsp;<span class="help-button" data-rel="popover" data-trigger="hover" data-placement="right" data-content="{$lang['hint_ri_dmax']}" >?</span>
		  </div>
		 </div>
		<div class="form-group">
