...
if( $action == "list" ) {
	...
	while ( $row = $db->get_array() ) {
		...
		$itemdate = @jdate( "H:i - Y/m/d", $row['date'] );
  ...
  <div class="box-content">
	...
	<div class="row box-section">
	  ...
	  <div class="col-md-6">
		  ...
		  <div class="col-lg-9">
			{$lang['edit_fdate']} <input id="PersianDate_A" type="text" name="fromnewsdate" id="fromnewsdate" size="13" maxlength="16" value="{$fromnewsdate}">
			{$lang['edit_tdate']} <input id="PersianDate_B" type="text" name="tonewsdate" id="tonewsdate" size="13" maxlength="16" value="{$tonewsdate}">
		  </div>
		 </div>
  ...
  <div class="box-content">
	...
	<div class="row box-section">
		...
		<div class="form-group">
		  ...
		  <div class="col-md-10">
			<input type="text" name="name" size="55" class="ltr">&nbsp;<span class="help-button" data-rel="popover" data-trigger="hover" data-placement="right" data-content="{$lang['hint_stitle']}" >?</span>
		  </div>
		 </div>
		<div class="form-group">
		...
		<div class="form-group">
		  ...
		  <div class="col-md-10">
			<input id="PersianDate_A" type="text" name="newdate" size="20" value="" class="ltr">&nbsp;<input type="checkbox" name="allow_now" id="allow_now" value="yes" checked>&nbsp;{$lang['edit_jdate']}
		  </div>
		 </div>
...
HTML;
	...
	echo <<<HTML
		...
		<div class="form-group">
		  ...
		  <div class="col-md-10">
			tpl . <input type="text" name="static_tpl" size="20">&nbsp;<span class="help-button" data-rel="popover" data-html="true" data-trigger="hover" data-placement="right" data-content="{$lang['hint_stpl']}" >?</span>
		  </div>
		 </div>	
		<div class="form-group">
...
HTML;
	...
	$name = trim( fatotranslit( $_POST['name'], true, false ) );
...
HTML;
	...
	echo <<<HTML
		<div class="form-group">
		  <label class="control-label col-md-2">{$lang['edit_edate']}</label>
		  <div class="col-md-10">
			<input id="PersianDate_A" type="text" name="newdate" value="{$itemdate}" class="ltr">&nbsp;<input type="checkbox" name="allow_date" id="allow_date" value="yes" onclick="CheckStatus(static)" checked>&nbsp;{$lang['edit_ndate']}&nbsp;<input type="checkbox" name="allow_now" id="allow_now" value="yes" disabled>&nbsp;{$lang['edit_jdate']}
		  </div>
		 </div>
		<script type="text/javascript">Calendar.setup({inputField:"PersianDate_A",ifFormat:"%Y-%m-%d %H:%M",align:"Br",timeFormat:"24",dateType:"jalali",showsTime:true,singleClick:true});</script>
...
HTML;
	...
	echo <<<HTML
		...
		<div class="form-group">
		  <label class="control-label col-md-2">{$lang['static_tpl']}</label>
		  <div class="col-md-10">
			tpl . <input type="text" name="static_tpl" size="20" value="{$row['tpl']}">&nbsp;<span class="help-button" data-rel="popover" data-html="true" data-trigger="hover" data-placement="right" data-content="{$lang['hint_stpl']}" >?</span>
		  </div>
		 </div>
HTML;
