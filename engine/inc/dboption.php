...
<div class="box">
  ...
  <div class="box-content">
	...
	<div class="row box-section">
	  ...
	  <div class="col-md-3">
		<select style="width:100%;" size="8" name="ta[]" multiple="multiple" class="ltr">{$tabellen}</select>
...
<div class="box">
  ...
  <div class="box-content">
	...
	<div class="row box-section">
		...
		{$lang['b_restore']} <select class="uniform ltr" name="file" id="file">{$files}</select>&nbsp;&nbsp;<input type="button" class="btn btn-red" onclick="dbload(); return false;" value="{$lang['b_load']}" />
