  ...
  <div class="box-content">
	...
	<div class="row box-section">
							...
							<div class="form-group">
							  ...
							  <div class="col-lg-10">
								<input size="40" type="text" name="regusername" class="ltr">
							  </div>
							 </div>
							<div class="form-group">
							  <label class="control-label col-lg-2">{$lang['user_pass']}</label>
							  <div class="col-lg-10">
								<input size="40" type="text" name="regpassword" class="ltr">
							  </div>
							 </div>
							<div class="form-group">
							  <label class="control-label col-lg-2">{$lang['user_mail']}</label>
							  <div class="col-lg-10">
								<input size="40" type="text" name="regemail" class="ltr">
							  </div>
							 </div>
							<div class="form-group">
	...
	<div class="row box-section">
	  ...
	  <div class="col-md-5">
							<div class="form-group">
							  <label class="control-label col-lg-2">{$lang['user_name']}</label>
							  <div class="col-lg-10">
								<input size="40" type="text" name="search_name" id="search_name" value="{$search_name}" class="ltr">&nbsp;<span class="help-button" data-rel="popover" data-trigger="hover" data-placement="right" data-content="{$lang['hint_user']}" >?</span>
							...
							<div class="form-group">
							  <label class="control-label col-lg-2">{$lang['user_mail']}</label>
							  <div class="col-lg-10">
								<input size="40" type="text" name="search_mail" id="search_mail" value="{$search_mail}" class="ltr">&nbsp;<span class="help-button" data-rel="popover" data-trigger="hover" data-placement="right" data-content="{$lang['hint_mail']}" >?</span>
							  </div>
							 </div>
							<div class="form-group">
	  ...
	  <div class="col-md-7">
							<div class="form-group">
							  ...
							  <div class="col-lg-8">
								{$lang['edit_fdate']}&nbsp;<input id="PersianDate_A" type="text" name="fromregdate" id="fromregdate" size="17" maxlength="16" value="{$fromregdate}" class="ltr">
								{$lang['edit_tdate']}&nbsp;<input id="PersianDate_B" type="text" name="toregdate" id="toregdate" size="17" maxlength="16" value="{$toregdate}" class="ltr">
							  </div>
							 </div>
							<div class="form-group">
							  <label class="control-label col-lg-4">{$lang['edit_entedate']}</label>
							  <div class="col-lg-8">
								{$lang['edit_fdate']}&nbsp;<input id="PersianDate_C" type="text" name="fromentdate" id="fromentdate" size="17" maxlength="16" value="{$fromentdate}" class="ltr">
								{$lang['edit_tdate']}&nbsp;<input id="PersianDate_D" type="text" name="toentdate" id="toentdate" size="17" maxlength="16" value="{$toentdate}" class="ltr">
							  </div>
							 </div>
							 <script type="text/javascript">
...
HTML;
	...
	while ( $row = $db->get_row() ) {
		...
		$last_login = langdate( 'Y/m/d - H:i', $row['lastdate'] );
		...
		if( $row[news_num] == 0 ) {
			...
			$news_link = <<<HTML
				<div class="btn-group">
				<a href="#" target="_blank" data-toggle="dropdown" data-original-title="تعداد مطالب ارسالی" class="status-info tip"><b>{$row['news_num']}</b></a>
...
HTML;
		...
		echo (langdate( "Y/m/d - H:i", $row['reg_date'] ));
		echo "</td>
...
HTML;
	...
	if( $row['time_limit'] != "" ) $row['time_limit'] = jdate( "Y-m-d H:i", $row['time_limit'] );
...
<table width="98%">
    <tr>
        ...
        <td>{$row['name']}</td>
        <td rowspan="6" valign="top" align="left"><img src="{$avatar}" border="0" style="max-width:100px;max-height:100px;" /></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><input size="20" class="edit bk ltr" name="editmail" value="{$row['email']}" /></td>
    </tr>
    <tr>
        <td colspan="3"><hr></td>
    </tr>
    <tr>
        ...
        <td colspan="2"><input size="20" name="editlogin" class="edit bk ltr"></td>
    </tr>
    <tr>
        <td style="padding:4px;">{$lang['user_newpass']}</td>
        <td colspan="2"><input size="20" name="editpass" class="edit bk ltr"></td>
    </tr>
    <tr>
        <td colspan="3"><hr></td>
    </tr>
...
HTML;
    ...
    <tr>
        ...
        <td colspan="2"><input id="PersianDate_A" size="20" name="time_limit" id="time_limit" class="edit bk ltr" value="{$row['time_limit']}"></td>
    </tr>
...
<option value="3" $restricted_selected[3]>{$lang['restricted_all']}</option>
    ...
    <tr>
        <td style="padding:4px;">ایمیل در Gravatar:</td>
        <td colspan="2"><input size="20" name="gravatar" value="{$gravatar}" class="edit bk ltr"></td>
    </tr>
    <tr>
