...
elseif( $action == "personal" ) {
	...
	$timezoneselect = "<select class=\"uniform\" dir=\"ltr\" style=\"direction: ltr !important;\" name=\"timezone\"><option value=\"\">{$lang['system_default']}</option>\r\n";
  ...
  <div class="box-content">
	...
	<div class="row box-section">
		...
		<div class="form-group">
		  ...
		  <div class="col-lg-10">
			<input style="width:100%;max-width:350px;" type="text" name="editmail" value="{$member_id['email']}" class="ltr">&nbsp;&nbsp;&nbsp;<input type="checkbox" name="edithidemail" {$ifchecked} id="edithidemail" value="1" />&nbsp;<label for="edithidemail">{$lang['opt_hmail']}</label>
		  </div>
		 </div>
		<div class="form-group">
		...
		<div class="form-group">
		  ...
		  <div class="col-lg-10">
			<input style="width:100%;max-width:350px;" name="altpass" type="password" class="ltr">&nbsp;<span class="help-button" data-rel="popover" data-trigger="hover" data-placement="right" data-content="{$lang['hint_pass']}" >?</span>
		  </div>
		 </div>
		<div class="form-group">
		  <label class="col-lg-2">{$lang['user_newpass']}</label>
		  <div class="col-lg-10">
			<input style="width:100%;max-width:350px;" type="text" name="editpassword" class="ltr">
		  </div>
		 </div>
		{$output}
	</div>
...
elseif( $action == "syscon" ) {
	...
	if( ! $handle = opendir( "./templates" ) ) {
		die( "Unable to open the directory ./templates" );
	}
	...
	if( ! $handle = opendir( "./language" ) ) {
		die( "Unable to open the directory ./data/language/" );
	}
	while ( false !== ($file = readdir( $handle )) ) {
...
HTML;
	...
	showRow( $lang['opt_sys_hu'], $lang['opt_sys_hud'], "<input type=text style=\"width:100%;\" name=\"save_con[http_home_url]\" value=\"{$config['http_home_url']}\" class=\"ltr\">" );
	showRow( $lang['opt_sys_chars'], $lang['opt_sys_charsd'], "<input type=\"text\" style=\"width:100%;\" name=\"save_con[charset]\" value=\"{$config['charset']}\" class=\"ltr\"" );
	...
	showRow( $lang['opt_sys_at'], $lang['opt_sys_atd']." ".jdate ( "d M Y ، H:i", time () ), makeDropDown( $langtimezones, "save_con[date_adjust]", "{$config['date_adjust']}", 1 ) );
	...
	showRow( $lang['opt_sys_al'], $lang['opt_sys_ald'], makeDropDown( $sys_con_langs_arr, "save_con[langs]", "{$config['langs']}", 1 ) );
	showRow( $lang['opt_sys_as'], $lang['opt_sys_asd'], makeDropDown( $sys_con_skins_arr, "save_con[skin]", "{$config['skin']}", 1 ) );
	showRow( $lang['opt_sys_wda'], $lang['opt_sys_wdad'], makeDropDown( array ("0" => $lang['editor_def'], "1" => "LiveEditor (WYSIWYG)", "2" => "TinyMCE (WYSIWYG)"), "save_con[allow_admin_wysiwyg]", "{$config['allow_admin_wysiwyg']}", 1 ) );
	showRow( $lang['opt_sys_wdst'], $lang['opt_sys_wdasd'], makeDropDown( array ("0" => $lang['editor_def'], "1" => "LiveEditor (WYSIWYG)", "2" => "TinyMCE (WYSIWYG)" ), "save_con[allow_static_wysiwyg]", "{$config['allow_static_wysiwyg']}", 1 ) );
...
HTML;
	...
	showRow( $lang['opt_sys_path'], $lang['opt_sys_pathd'], "<input type=\"text\" class=\"ltr\" name=\"save_con[admin_path]\" value=\"{$config['admin_path']}\" size=50>", "white-line" );
	...
	showRow( $lang['opt_sys_iprest'], $lang['opt_sys_iprestd'], "<textarea style=\"width:100%;height:100px;\" class=\"ltr\" name=\"save_con[admin_allowed_ip]\">{$config['admin_allowed_ip']}</textarea>" );
	...
	showRow( $lang['opt_sys_recaptpub'], $lang['opt_sys_recaptpubd'], "<input  type=text class=\"ltr\" name=\"save_con[recaptcha_public_key]\" value=\"{$config['recaptcha_public_key']}\" size=50>" );
	showRow( $lang['opt_sys_recaptpriv'], $lang['opt_sys_recaptpubd'], "<input  type=text class=\"ltr\" name=\"save_con[recaptcha_private_key]\" value=\"{$config['recaptcha_private_key']}\" size=50>" );
...
HTML;
	...
	showRow( $lang['opt_sys_cls'], $lang['opt_sys_clsd'], "<input  type=text class=\"ltr\" style=\"text-align: center;\"  name=\"save_con[category_separator]\" value=\"{$config['category_separator']}\" size=20>" );
	showRow( $lang['opt_sys_spbs'], $lang['opt_sys_spbsd'], "<input  type=text class=\"ltr\" style=\"text-align: center;\"  name=\"save_con[speedbar_separator]\" value=\"{$config['speedbar_separator']}\" size=20>" );
	showRow( $lang['opt_sys_am'], $lang['opt_sys_amd'], "<input  type=text class=\"ltr\" style=\"width:100%;\"  name=\"save_con[smilies]\" value=\"{$config['smilies']}\" >" );
...
HTML;
	...
	showRow( $lang['group_c_restr'], $lang['group_c_restrd'], "<input  type=text class=\"ltr\" style=\"text-align: center;\"  name=\"save_con[comments_restricted]\" value=\"{$config['comments_restricted']}\" size=20>" );
	...
	showRow( $lang['opt_sys_minc'], $lang['opt_sys_mincd'], "<input  type=text class=\"ltr\" style=\"text-align: center;\"  name='save_con[comments_minlen]' value=\"{$config['comments_minlen']}\" size=20>" );
	showRow( $lang['opt_sys_maxc'], $lang['opt_sys_maxcd'], "<input  type=text class=\"ltr\" style=\"text-align: center;\"  name='save_con[comments_maxlen]' value=\"{$config['comments_maxlen']}\" size=20>" );
	showRow( $lang['opt_sys_cpm'], $lang['opt_sys_cpmd'], "<input  type=text class=\"ltr\" style=\"text-align: center;\"  name='save_con[comm_nummers]' value=\"{$config['comm_nummers']}\" size=20>" );
	...
	showRow( $lang['opt_sys_af'], $lang['opt_sys_afd'], "<input  type=text class=\"ltr\" style=\"text-align: center;\"  name='save_con[flood_time]' value=\"{$config['flood_time']}\" size=20>" );
	showRow( $lang['opt_sys_aw'], $lang['opt_sys_awd'], "<input  type=text class=\"ltr\" style=\"text-align: center;\"  name='save_con[auto_wrap]' value=\"{$config['auto_wrap']}\" size=20>" );
...
HTML;
	...
	showRow( $lang['opt_sys_memserv'], $lang['opt_sys_memservd'], "<input  type=text class=\"ltr\" name=\"save_con[memcache_server]\" value=\"{$config['memcache_server']}\" size=40>" );
...
HTML;
	...
	showRow( $lang['opt_sys_maxfilec'], $lang['opt_sys_maxfilecd'], "<input  type=text class=\"ltr\" style=\"text-align: center;\"  name='save_con[max_file_count]' value=\"{$config['max_file_count']}\" size=20>" );
...
HTML;
	...
	showRow( $lang['opt_sys_amail'], $lang['opt_sys_amaild'], "<input  type=text name='save_con[admin_mail]' value='{$config['admin_mail']}' size=40 class=\"ltr\">", "white-line" );
	...
	showRow( $lang['opt_sys_smtph'], $lang['opt_sys_smtphd'], "<input  type=text class=\"ltr\" name='save_con[smtp_host]' value=\"{$config['smtp_host']}\" size=40>" );
	showRow( $lang['opt_sys_smtpp'], $lang['opt_sys_smtppd'], "<input  type=text class=\"ltr\" style=\"text-align: center;\" name='save_con[smtp_port]' value=\"{$config['smtp_port']}\" size=20>" );
	showRow( $lang['opt_sys_smtup'], $lang['opt_sys_smtpud'], "<input  type=text class=\"ltr\" name='save_con[smtp_user]' value=\"{$config['smtp_user']}\" size=40>" );
	showRow( $lang['opt_sys_smtupp'], $lang['opt_sys_smtpupd'], "<input  type=text class=\"ltr\" name='save_con[smtp_pass]' value=\"{$config['smtp_pass']}\" size=40>" );
	...
	showRow( $lang['opt_sys_smtpm'], $lang['opt_sys_smtpmd'], "<input  type=text class=\"ltr\" name='save_con[smtp_mail]' value=\"{$config['smtp_mail']}\" size=40>" );
...
HTML;
	...
	showRow( $lang['opt_sys_um'], $lang['opt_sys_umd'], "<input  type=text class=\"ltr\" style=\"text-align: center;\"  name='save_con[max_users]' value=\"{$config['max_users']}\" size=20>" );
	showRow( $lang['opt_sys_ud'], $lang['opt_sys_udd'], "<input  type=text class=\"ltr\" style=\"text-align: center;\"  name='save_con[max_users_day]' value=\"{$config['max_users_day']}\" size=20>" );
...
HTML;
	...
	showRow( $lang['opt_sys_dim'], $lang['opt_sys_dimd'], "<input  type=text class=\"ltr\" style=\"text-align: center;\"  name='save_con[max_image_days]' value=\"{$config['max_image_days']}\" size=20>" );
	showRow( $lang['opt_sys_iw'], $lang['opt_sys_iwd'], makeCheckBox( "save_con[allow_watermark]", "{$config['allow_watermark']}" ) );
	showRow( $lang['opt_sys_im'], $lang['opt_sys_imd'], "<input  type=text class=\"ltr\" style=\"text-align: center;\"  name='save_con[max_watermark]' value=\"{$config['max_watermark']}\" size=20>" );
	...
	showRow( $lang['opt_sys_ia'], $lang['opt_sys_iad'], "<input  type=text class=\"ltr\" style=\"text-align: center;\"  name='save_con[max_image]' value=\"{$config['max_image']}\" size=20>" );
	...
	showRow( $lang['opt_sys_ij'], $lang['opt_sys_ijd'], "<input  type=text class=\"ltr\" style=\"text-align: center;\"  name='save_con[jpeg_quality]' value=\"{$config['jpeg_quality']}\" size=20>" );
	showRow( $lang['opt_sys_av'], $lang['opt_sys_avd'], "<input  type=text class=\"ltr\" style=\"text-align: center;\"  name='save_con[avatar_size]' value=\"{$config['avatar_size']}\" size=20>" );

	showRow( $lang['opt_sys_imw'], $lang['opt_sys_imwd'], "<input  type=text class=\"ltr\" style=\"text-align: center;\"  name='save_con[tag_img_width]' value=\"{$config['tag_img_width']}\" size=20>" );
