	...
	default :
		...
		if ($do == "cat" and $category != '' and $subaction == '') {
			...
			if ($year != '' and $month == '' and $day == '') {
				...
				$sql_count = "SELECT COUNT(*) as count FROM " . PREFIX . "_post where {$stop_list}date >= '$starty' AND date < '$endy' AND approve=1" . $where_date;
			}
			...
			if ($year != '' and $month != '' and $day == '') {
				...
				$sql_count = "SELECT COUNT(*) as count FROM " . PREFIX . "_post where {$stop_list}date >= '$startm' AND date < '$endm' AND approve=1" . $where_date;
			}
			...
			if ($year != '' and $month != '' and $day != '' and $subaction == '') {
				...
				$sql_count = "SELECT COUNT(*) as count FROM " . PREFIX . "_post WHERE {$stop_list}date >= '{$startd}' AND date < '{$startd}' + INTERVAL 24 HOUR AND approve=1" . $where_date;
